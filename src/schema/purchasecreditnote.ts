...
const PurchaseCreditNoteSchema = object({
...
type PurchaseCreditNoteForm = InferInput<typeof PurchaseCreditNoteSchema>;

export { PurchaseCreditNoteSchema, type PurchaseCreditNoteForm };
