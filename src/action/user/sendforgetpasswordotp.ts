...
const SendForgetPasswordOtp = async (
  ...
  try {
    ...
    await axios.get(
      `http://sms.smartechwebworks.com/submitsms.jsp?user=dddnhvat&key=8b85ee3e9fXX&mobile=+91${mobile}&message=${message}&senderid=VATDNH&accusage=1&entityid=1701174159851422588&tempid=1707174989299822848`,
    );
