...
const Dvat1Page = (props: Dvat1PageProps) => {
  enum TrueFalse {
    YES = "YES",
    NO = "NO",
  }
  ...
  useEffect(() => {
    const init = async () => {
      ...
      const dvatdata = await GetDvat({ userid: props.userid });
...
const Dvat2Page = (props: Dvat2PageProps) => {
...
const Dvat3Page = (props: Dvat3PageProps) => {
  const [isLoading, setIsLoading] = useState<boolean>(false);
