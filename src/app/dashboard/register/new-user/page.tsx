      ...
      <div className="bg-white w-full p-4 px-8 shadow mt-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 mt-2">
          ...
          <div className="border rounded-md p-4 mb-4 bg-gray-50">
            <h2 className="font-semibold text-base mb-3 text-blue-700">
              User Section
            </h2>
          ...
          <div className="border rounded-md p-4 bg-gray-50">
            <h2 className="font-semibold text-base mb-3 text-green-700">
              Company Section
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  Prefix rule: DAMAN=2500, DIU=2501, Dadra_Nagar_Haveli=2600 or
                  2650
                </p>
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
              <div>
                ...
                <select
                  ...
                  value={selectOffice}
                  onChange={(e) =>
                    setSelectOffice(e.target.value as SelectOffice)
                  }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    const isCompositionYes = e.target.value === "YES";
                    setCompositionScheme(isCompositionYes);
