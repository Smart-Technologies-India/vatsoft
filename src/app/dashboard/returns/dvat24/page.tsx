        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          ...
          <div className="border-b border-gray-200">
            <div className="bg-linear-to-r from-blue-50 to-indigo-50 px-6 py-3">
              <h2 className="text-lg font-semibold text-gray-900">Details Of Taxpayer</h2>
            </div>
          </div>
          <div className="p-6 bg-gray-50 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="space-y-1">
              <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">User TIN Number</p>
          ...
          <div className="p-6 bg-white border-t border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="space-y-1">
                <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Ref Number</p>
                <p className="text-sm font-semibold text-gray-900">
                  {capitalcase(data?.notice.ref_no ?? "").toUpperCase()}
                </p>
              </div>
              <div className="space-y-1">
                <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Reason For Notice</p>
                <p className="text-sm font-semibold text-gray-900">
              ...
              <div className="space-y-1">
                <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Tax Period From - To</p>
                <p className="text-sm font-semibold text-gray-900">
              ...
              <Table className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                ...
                <TableBody>
                  <TableRow className="hover:bg-blue-50 transition-colors">
                    <TableCell className="text-left px-4 py-3 border font-medium text-gray-900">Tax</TableCell>
            ...
            <div className="lg:w-96 shrink-0">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4">
                <div className="text-center">
                  <h3 className="text-xl font-bold text-gray-900">Form DVAT 24</h3>
                ...
                {data?.notice.remark != null &&
                  ...
                  data?.notice.remark != "" && (
                    <div className="bg-linear-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
                      <p className="text-xs font-semibold text-gray-700 uppercase tracking-wide mb-2">Remark</p>
                      <p className="text-sm text-gray-900">{data?.notice.remark}</p>
                    </div>
                  )}
