            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 space-y-3">
                <p className="text-sm text-gray-700 leading-relaxed">
                  <span className="font-semibold text-gray-900">1.</span> Being
                  a registered Seller, you are required to furnish return for
                  the Sales made or received and to discharge resultant tax
                  liability for the aforesaid tax period by due date. It has
                  been noticed that you have not filed the said return till
                  date.
                </p>
                <p className="text-sm text-gray-700 leading-relaxed">
                  <span className="font-semibold text-gray-900">2.</span> You
                  are, therefore, requested to furnish the said return within 15
                  days failing which the tax liability may be assessed u/s 32 of
                  the regulation, based on the relevant material available with
                  this office. Please note that in addition to tax so assessed,
                  you will also be liable to pay interest and penalty as per
                  provisions of the regulation.
                </p>
                <p className="text-sm text-gray-700 leading-relaxed">
                  <span className="font-semibold text-gray-900">3.</span> Please
                  note that no further communication will be issued for
                  assessing the liability.
                </p>
                <p className="text-sm text-gray-700 leading-relaxed">
                  <span className="font-semibold text-gray-900">4.</span> The
                  notice shall be deemed to have been withdrawn in case the
                  return referred above, is filed by you before issue of the
                  assessment order.
                </p>
                <p className="text-sm text-gray-700 leading-relaxed">
                  <span className="font-semibold text-gray-900">5.</span> This
                  is a system generated notice and will not require signature.
                </p>
              </div>
            </div>
          </div>
