    ...
    <>
      <div className="min-h-screen bg-linear-to-br from-gray-50 via-blue-50 to-indigo-50 p-4">
        ...
        >
          ...
          <div className="border border-black p-2 h-full w-full relative">
            ...
            <table border={1} className="w-5/6 mx-auto mt-6">
              <tbody className="w-full">
                ...
                <tr className="w-full">
                  ...
                  <td className="px-2 text-xs leading-6 w-[50%]">
                    {formateDate(new Date(fformdata?.createdAt!)).replaceAll(
                      "-",
                      "/"
                    )}
                  </td>
                ...
                <tr className="w-full">
                  ...
                  <td className="px-2 text-xs leading-6 w-[50%]">
                    {fformdata
                      ? formateDate(new Date(fformdata.valid_date)).replaceAll(
                          "-",
                          "/"
                        )
                      : ""}
            ...
            <p className="w-5/6 mx-auto my-6 text-xs text-justify leading-6">
              ...
              Federal Sales Tax Act.[It is further certified that I/We
        ...
        {/* part two end here */}
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-b-xl p-6 border-t border-gray-200">
            <Button
              type="primary"
              onClick={() => generatePDF("mainpdf", `F-Form-${fformdata?.sr_no}`)}
