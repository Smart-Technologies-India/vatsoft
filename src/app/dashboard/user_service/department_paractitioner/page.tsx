...
"use client";
import { Radio, Pagination, Drawer } from "antd";
...
const SupplierDetails = () => {
  ...
  const [paractitionerid, setParactitionerid] = useState<number>();
    ...
    <>
      ...
      >
        <p className="text-lg text-left">
          {paractitionerid ? "Update" : "Add"} Paractitioner
        </p>
        <ParactitionerMasterProvider
          userid={userid}
          id={paractitionerid}
          setAddBox={setAddBox}
          setParactitionerid={setParactitionerid}
          init={init}
        />
      </Drawer>
      <div className="p-4">
        <div className="bg-white p-2 shadow mt-2">
          <div className="flex gap-2">
            <p className="text-lg font-semibold">VAT Paractitioner</p>
