    ...
    <>
      <main className="bg-[#f8fafe] pb-8">
        <header className="bg-[#0b1e59] w-full py-2 flex gap-2 px-4 items-center">
          ...
          <button className="text-[#0b1e59] bg-white rounded px-4 py-1 font-medium ">
            REGISTER
          </button>
          <button className="text-[#0b1e59] bg-white rounded px-4 py-1 font-medium ">
            LOGIN
          ...
          <div className="flex gap-10">
            ...
            <div className="flex-1 bg-white rounded-md border border-[#0b1e59] p-2">
              <div className="flex">
                ...
                <div className="grow"></div>
                <p className="font-medium text-[#0b1e59] text-sm">View All</p>
              </div>
              <NewsCard />
      ...
      <div className="bg-gray-100 py-8">
        <section className="mx-auto w-5/6">
          ...
          <div className="grid mt-4 gap-4 items-end grid-cols-2">
          ...
          <div className="border-2 border-gray-400 p-2 mt-4 rounded-md">
...
const DateCard = (props: DateCardProps) => {
  return (
    <div className="px-4 py-2 shadow-sm rounded bg-white">
