...
type AddDvat30EntryProviderProps = {};
export const AddDvat30EntryProvider = (props: AddDvat30EntryProviderProps) => {
...
const AddDvat30Entry = (props: AddDvat30EntryProviderProps) => {
