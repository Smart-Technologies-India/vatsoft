...
type DepartmentPayCSTProviderProps = {
  userid: number;
  returnId?: number;
  returnContext?: {
    year: string;
      ...
      <form onSubmit={handleSubmit(onSubmit, onFormError)}>
        ...
        <div className="flex gap-4">
          ...
          <div className="w-96 shrink-0 p-2">
            <p className="text-center text-xl font-semibold">Form Challan</p>
            <p className="mt-2 text-sm">XII Sales Tax (Central)</p>
            <p className="mt-3 text-sm">
              Receipt Under the Central Sales Tax Act
            </p>
            <p className="mt-3 text-sm">
              Challan of Tax, Penalty, Composition Money, Registration Fee and
              Other Fee Paid.
            </p>
            <Separator />
